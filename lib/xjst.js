...
"localExpr":function(){var $elf=this,_fromIdx=this.input.idx,n,c,bla;return (function(){bla=this._form((function(){return (function(){this._applyWithArgs("exactly","set");this._form((function(){return (function(){this._applyWithArgs("exactly","get");return n=this._apply("anything")}).call(this)}));return c=this._apply("anything")}).call(this)}));return (function (){var id=XJSTParser._getLocalId();return [[["begin",["var",("__v" + id),["get",n]]],["set",["get",n],c]],[["set",["get",n],["get",("__v" + id)]]]]}).call(this)}).call(this)},
"tBody":function(){var $elf=this,_fromIdx=this.input.idx;return this._apply("stmt")},
"subMatch":function(){var $elf=this,_fromIdx=this.input.idx,e1,c,e2;return this._or((function(){return (function(){this._form((function(){return (function(){this._applyWithArgs("exactly","binop");this._applyWithArgs("exactly","==");e1=this._apply("anything");return c=this._apply("const")}).call(this)}));return [e1,c]}).call(this)}),(function(){return (function(){e2=this._apply("anything");return [e2,["get","true"]]}).call(this)}))},
...
"template":function(){var $elf=this,_fromIdx=this.input.idx,m,b;return (function(){this._form((function(){return (function(){m=this._apply("tMatch");return b=this._apply("tBody")}).call(this)}));return (((("    if(" + m) + ") ") + b) + ";")}).call(this)},
