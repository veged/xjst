...
XJSTParser.prototype["primExprHd"] = function $primExprHd() {
    return this._atomic(function() {
        var a, b, r;
        return this._rule("token", true, [ "local" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("asgnExpr", false, [], null, this["asgnExpr"]) && (b = this._getIntermediate(), true) && this._rule("localExpr", false, [ [ "local", a, b ] ], null, this["localExpr"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        var st;
        return this._rule("token", true, [ "super" ], null, this["token"]) && this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("superExpr", false, [ [ "super" ] ], null, this["superExpr"]) && (st = this._getIntermediate(), true) && this._exec(st);
    }) || this._atomic(function() {
        var a, st, r;
        return this._rule("token", true, [ "super" ], null, this["token"]) && this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("superExpr", false, [ [ "super" ] ], null, this["superExpr"]) && (st = this._getIntermediate(), true) && this._rule("localExpr", false, [ [ "local", a, st ] ], null, this["localExpr"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        var st;
        return this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._exec(st);
    }) || this._atomic(function() {
        var a, st, r;
        return this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._rule("localExpr", false, [ [ "local", a, st ] ], null, this["localExpr"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        var expr;
        return this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("applyExpr", false, [ [ "apply" ] ], null, this["applyExpr"]) && (expr = this._getIntermediate(), true) && this._exec(expr);
    }) || this._atomic(function() {
        return this._rule("primExprHd", false, [], BSJSParser, BSJSParser.prototype["primExprHd"]);
    });
};
...
XJSTParser.prototype["stmt"] = function $stmt() {
    return this._atomic(function() {
        var a, b, r;
        return this._rule("token", true, [ "local" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("stmt", false, [], null, this["stmt"]) && (b = this._getIntermediate(), true) && this._rule("localStmt", false, [ [ "local", a, b ] ], null, this["localStmt"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        var st;
        return this._rule("token", true, [ "super" ], null, this["token"]) && this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("superStmt", false, [ [ "super" ] ], null, this["superStmt"]) && (st = this._getIntermediate(), true) && this._exec(st);
    }) || this._atomic(function() {
        var a, st, r;
        return this._rule("token", true, [ "super" ], null, this["token"]) && this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("superStmt", false, [ [ "super" ] ], null, this["superStmt"]) && (st = this._getIntermediate(), true) && this._rule("localStmt", false, [ [ "local", a, st ] ], null, this["localStmt"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        var st;
        return this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._exec(st);
    }) || this._atomic(function() {
        var a, st, r;
        return this._rule("token", true, [ "apply" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (a = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._rule("localStmt", false, [ [ "local", a, st ] ], null, this["localStmt"]) && (r = this._getIntermediate(), true) && this._exec(r);
    }) || this._atomic(function() {
        return this._rule("stmt", false, [], BSJSParser, BSJSParser.prototype["stmt"]);
    });
};

XJSTParser.prototype["extends"] = function $extends() {
    var filename;
    return this._rule("token", true, [ "extends" ], null, this["token"]) && this._rule("spaces", false, [], null, this["spaces"]) && this._rule("str", false, [], null, this["str"]) && (filename = this._getIntermediate(), true) && this._exec([ "extends", filename[1] ]);
};

XJSTParser.prototype["template"] = function $template() {
    var m, b;
    return this._rule("token", true, [ "template" ], null, this["token"]) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("expr", false, [], null, this["expr"]) && (m = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("stmt", false, [], null, this["stmt"]) && (b = this._getIntermediate(), true) && this._exec([ "template", m, b ]);
};
...
XJSTParser.prototype["superExpr"] = function $superExpr() {
    ...
    }) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._exec([ "superExpr", st ]);
};
...
XJSTParser.prototype["superStmt"] = function $superStmt() {
    ...
    return this._list(function() {
        return this._match("super");
    }) && this._rule("applyStmt", false, [ [ "apply" ] ], null, this["applyStmt"]) && (st = this._getIntermediate(), true) && this._exec([ "superStmt", st ]);
};
...
XJSTParser.prototype["topLevel"] = function $topLevel() {
    ...
    return this._many(function() {
        return this._atomic(function() {
            var t;
            return this._rule("extends", false, [], null, this["extends"]) && (t = this._getIntermediate(), true) && this._exec(t);
        }) || this._atomic(function() {
            var t;
            return this._rule("template", false, [], null, this["template"]) && (t = this._getIntermediate(), true) && this._exec(t);
        }) || this._atomic(function() {
            var s;
            return this._rule("srcElem", false, [], null, this["srcElem"]) && (s = this._getIntermediate(), true) && this._exec([ "stmt", s ]);
        });
    }) && (ts = this._getIntermediate(), true) && this._rule("spaces", false, [], null, this["spaces"]) && this._rule("end", false, [], null, this["end"]) && this._exec(ts);
};
...
XJSTTranslator.prototype["superStmt"] = function $superStmt() {
    var op, st;
    return this._skip() && (op = this._getIntermediate(), true) && this._rule("localStmt", false, [ [ "json", [ "binding", "__d0" + this.id, [ "get", true ] ] ], op ], null, this["localStmt"]) && (st = this._getIntermediate(), true) && this._exec(function() {
        return st;
    }.call(this));
};
...
XJSTTranslator.prototype["superExpr"] = function $superExpr() {
    var op, st;
    return this._skip() && (op = this._getIntermediate(), true) && this._rule("localExpr", false, [ [ "json", [ "binding", "__d" + this.id, [ "get", true ] ] ], op ], null, this["localExpr"]) && (st = this._getIntermediate(), true) && this._exec(function() {
        return st;
    }.call(this));
};
...
XJSTTranslator.prototype["localStmt"] = function $localStmt() {
    var as, t;
    return this._rule("localAsmts", false, [], null, this["localAsmts"]) && (as = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (t = this._getIntermediate(), true) && this._exec(function() {
...
XJSTTranslator.prototype["bindingToAsmt"] = function $bindingToAsmt() {
    ...
    }) && this._rule("localAsmt", false, [ [ "set", [ "getp", [ "string", k ], [ "get", "__this" ] ], v ] ], null, this["localAsmt"]) && (r = this._getIntermediate(), true) && this._exec(r);
};
    ...
    return this._atomic(function() {
        ...
        return this._list(function() {
            return this._match("json") && this._any(function() {
                return this._rule("bindingToAsmt", false, [], null, this["bindingToAsmt"]);
        ...
        var e1;
        return this._rule("localAsmt", false, [], null, this["localAsmt"]) && (e1 = this._getIntermediate(), true) && this._exec(e1);
    }) || this._atomic(function() {
        var es, e2;
        return this._list(function() {
            return this._match("binop") && this._match(",") && this._rule("localAsmts", false, [], null, this["localAsmts"]) && (es = this._getIntermediate(), true) && this._rule("localAsmt", false, [], null, this["localAsmt"]) && (e2 = this._getIntermediate(), true);
        }) && this._exec(function() {
...
XJSTTranslator.prototype["localAsmt"] = function $localAsmt() {
    ...
    }) && this._rule("localProps", false, [ p ], null, this["localProps"]) && (props = this._getIntermediate(), true) && this._exec(function() {
...
XJSTTranslator.prototype["localProps"] = function $localProps() {
    return this._atomic(function() {
        var k, expr;
        return this._list(function() {
            return this._match("getp") && this._rule("const", false, [], null, this["const"]) && (k = this._getIntermediate(), true) && this._list(function() {
        ...
        var k, o;
        return this._list(function() {
            return this._match("getp") && this._rule("const", false, [], null, this["const"]) && (k = this._getIntermediate(), true) && this._skip() && (o = this._getIntermediate(), true);
        }) && this._exec(function() {
            var v = XJSTTranslator._getLocalVar(this);
...
XJSTTranslator.prototype["subMatch"] = function $subMatch() {
    return this._atomic(function() {
        var e1, c;
        return this._list(function() {
            return this._match("binop") && this._match("===") && this._skip() && (e1 = this._getIntermediate(), true) && this._rule("const", false, [], null, this["const"]) && (c = this._getIntermediate(), true);
        }) && this._exec([ e1, c ]);
    }) || this._atomic(function() {
        var c, e2;
        return this._list(function() {
            return this._match("binop") && this._match("===") && this._rule("const", false, [], null, this["const"]) && (c = this._getIntermediate(), true) && this._skip() && (e2 = this._getIntermediate(), true);
        }) && this._exec([ e2, c ]);
    }) || this._atomic(function() {
        var e3;
...
XJSTTranslator.prototype["expr2match"] = function $expr2match() {
    return this._atomic(function() {
        var ms, m1;
        return this._list(function() {
            return this._match("binop") && this._match("&&") && this._rule("expr2match", false, [], null, this["expr2match"]) && (ms = this._getIntermediate(), true) && this._rule("subMatch", false, [], null, this["subMatch"]) && (m1 = this._getIntermediate(), true);
        }) && this._exec(function() {
            ms.push(m1);
            return ms;
        }.call(this));
        ...
        var m2;
        return this._rule("subMatch", false, [], null, this["subMatch"]) && (m2 = this._getIntermediate(), true) && this._exec([ m2 ]);
    });
};

XJSTTranslator.prototype["template"] = function $template() {
    var m, b;
    return this._skip() && (m = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (b = this._getIntermediate(), true) && this._exec([ "template", [ XJSTTranslator.match(m, "expr2match"), b ] ]);
};
...
XJSTLocalAndApplyCompiler.prototype["superStmt"] = function $superStmt() {
    var op;
    return this._rule("trans", false, [], null, this["trans"]) && (op = this._getIntermediate(), true) && this._exec([ "superStmt", op ]);
};

XJSTLocalAndApplyCompiler.prototype["superExpr"] = function $superExpr() {
    var op;
    return this._rule("trans", false, [], null, this["trans"]) && (op = this._getIntermediate(), true) && this._exec([ "superExpr", op ]);
};
...
XJSTLocalAndApplyCompiler.prototype["topLevel"] = function $topLevel() {
    var t;
    return this._exec(this.result = []) && this._rule("trans", false, [], null, this["trans"]) && (t = this._getIntermediate(), true) && this._exec(this.result);
};
...
XJSTCompiler.prototype["extends"] = function $extends() {
    var filename;
    return this._rule("trans", false, [], null, this["trans"]) && (filename = this._getIntermediate(), true) && this._exec(function() {
...
XJSTCompiler.prototype["superStmt"] = function $superStmt() {
    var op;
    return this._rule("trans", false, [], null, this["trans"]) && (op = this._getIntermediate(), true) && this._exec(op);
};
...
XJSTCompiler.prototype["localStmt"] = function $localStmt() {
    var a, b;
    return this._rule("trans", false, [], null, this["trans"]) && (a = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (b = this._getIntermediate(), true) && this._exec(function() {
        return "local (" + a + ") " + b + ";";
    }.call(this));
};
...
XJSTCompiler.prototype["subMatch"] = function $subMatch() {
    return this._atomic(function() {
        var id, m;
        return this._list(function() {
            return this._skip() && (id = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (m = this._getIntermediate(), true) && this._list(function() {
        ...
        var id, e, c;
        return this._list(function() {
            return this._skip() && (id = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (e = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (c = this._getIntermediate(), true);
        }) && this._exec(e + " === " + c);
    });
};
...
XJSTCompiler.prototype["tMatch"] = function $tMatch() {
    return this._atomic(function() {
        var m;
        return this._list(function() {
            return this._rule("subMatch", false, [], null, this["subMatch"]) && (m = this._getIntermediate(), true);
        }) && this._exec(m);
    }) || this._atomic(function() {
        var ms;
        return this._list(function() {
            return this._many(function() {
                return this._rule("subMatch", false, [], null, this["subMatch"]);
...
XJSTCompiler.prototype["template"] = function $template() {
    var m, b;
    return this._list(function() {
        return this._rule("tMatch", false, [], null, this["tMatch"]) && (m = this._getIntermediate(), true) && this._rule("tBody", false, [], null, this["tBody"]) && (b = this._getIntermediate(), true);
...
XJSTCompiler.prototype["templates"] = function $templates() {
    ...
    return this._list(function() {
        return this._any(function() {
            return this._rule("template", false, [], null, this["template"]);
    ...
    return this._atomic(function() {
        ...
        return this._list(function() {
            return this._match("begin") && this._any(function() {
                return this._rule("skipBraces", false, [], null, this["skipBraces"]);
...
XJSTCompiler.prototype["topLevel"] = function $topLevel() {
    var o, t;
    return this._list(function() {
        return this._rule("other", false, [], null, this["other"]) && (o = this._getIntermediate(), true) && this._rule("templates", false, [], null, this["templates"]) && (t = this._getIntermediate(), true);
    }) && this._exec(function() {
