...
if (global === ometajs_) {
  ...
  OMeta = require('ometajs').OMeta;
    ...
    var XJSTTranslator = exports.XJSTTranslator = objectThatDelegatesTo(BSJSIdentity, {
        ...
        localExpr: function() {
            ...
            return function() {
                ...
                t = this._apply("trans");
                return function() {
                    var prelude = [ [ "localStart", XJSTTranslator._localToPred(this["identifier"], as), as[0].filter(function(op) {
                        return op[0] === "var";
                    }).map(function(op) {
                        return op.slice(1).map(function(asmt) {
                            return [ asmt[0] ];
                        });
                    }) ] ], result = XJSTTranslator._getLocalVar(this), $elf = this;
    ...
    var XJSTLocalAndApplyCompiler = exports.XJSTLocalAndApplyCompiler = objectThatDelegatesTo(BSJSIdentity, {
        ...
        localStart: function() {
            var $elf = this, _fromIdx = this.input.idx, as, vars;
            return function() {
                as = this._apply("anything");
                vars = this._apply("anything");
                return function() {
