...
Compiler.prototype.generate = function generate(code) {
  if (this.options['no-opt'] || this.options.optimize === false) {
    return utils.run.toString() + ';\n' +
           ...
           '};\n' +
           'try {\n' +
           '  applyc({ $override:true, $exports: exports });\n' +
           '} catch (e) {\n' +
...
Compiler.prototype.addChange = function addChange(ctx, predicate, fn) {
...
Compiler.prototype.render = function render(program, bodyOnly) {
  ...
  stmts.push({
    ...
    expression: {
      ...
      arguments: [{
        ...
        properties: [{
          type: 'Property',
          key: { type: 'Literal', value: '$override' },
          value: { type: 'Literal', value: true },
          kind: 'init'
        }, {
          type: 'Property',
          key: { type: 'Literal', value: '$exports' },
  ...
  // Disallow templates going under $override
  ...
  if (!bodyOnly) {
    applyBody.push({
      ...
      test: {
        ...
        computed: false,
        object: this.ctx,
        property: { type: 'Identifier', name: '$override' }
      },
      consequent: {
        type: 'ReturnStatement',
        argument: null
