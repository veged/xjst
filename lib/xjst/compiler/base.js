...
Compiler.prototype.getSkipApplyNext = function getSkipApplyNext() {
  var ctx = { type: 'Identifier', name: 'ctx' };
  var save = {
    type: 'VariableDeclaration',
    kind: 'var',
  ...
  var res = { type: 'Identifier', name: 'res' };
  save.declarations.push({
    type: 'VariableDeclarator',
    id: res,
    init: null
  });
  ...
  for (var i = 0; i < this.applyNext.count; i++) {
    var flagName = { type: 'Identifier', name: '__$a' + i };
    var flagValue = {
      type: 'MemberExpression',
      computed: false,
      object: ctx,
  ...
  var cb = { type: 'Identifier', name: 'cb' };
    ...
    expression: {
      ...
      arguments: [{
        ...
        properties: [{
          ...
          type: 'Property',
          key: { type: 'Literal', value: 'skipApplyNext' },
          value: this.getSkipApplyNext(),
          kind: 'init'
        }]
      }]
    }
