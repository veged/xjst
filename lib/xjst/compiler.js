...
exports.generate = function generate(templatesAndOther) {
  ...
  function doTemplate(i, j, predicMemo) {
    ...
    if (known) return doTemplate(i + 1, 0, predicMemo);
    ...
    if(predicMemo.hasOwnProperty(predicate)) {
      ...
      return merge({
        ...
        'default': doTemplate(i, j,
                              utils.cloneChanged(predicMemo,
                                                 predicate,
                                                 undefined))
      });
    }
  ...
  function serializeTop(prog) {
    ...
    return ['exports.apply = function(c) {\n']
